...
public class WechatShareManager {
    ...
    private WechatShareManager(Context context, String WX_APP_ID){
        this.mContext = context;
        //初始化数据
        //初始化微信分享代码
        initWechatShare(context,WX_APP_ID);
    }
     ...
     * @return
     */
    public static WechatShareManager getInstance(Context context,String WX_APP_ID ){
        if(mInstance == null){
            mInstance = new WechatShareManager(context,WX_APP_ID );
        }
        return mInstance;
    }

    private void initWechatShare(Context context,String WX_APP_ID){
        if (mWXApi == null) {
...
//            msg.thumbData = Util.bmpToByteArray(thumb, true);
    ...
    private void shareVideo(ShareContent shareContent, int shareType) {
        ...
        msg.title = shareContent.getTitle();
        msg.description = shareContent.getContent();
        Bitmap thumb = BitmapFactory.decodeResource(mContext.getResources(), R.drawable.umeng_socialize_share_music);
