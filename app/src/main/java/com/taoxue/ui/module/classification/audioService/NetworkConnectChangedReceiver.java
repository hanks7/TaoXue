...
public class NetworkConnectChangedReceiver extends BroadcastReceiver {
    String TAG1 = "cc";
    private AudioPlayDelegate playDelegate;

    public NetworkConnectChangedReceiver(AudioPlayDelegate playDelegate) {
...
//                    APP.getInstance().setEnablaWifi(true);
        ...
        if (WifiManager.NETWORK_STATE_CHANGED_ACTION.equals(intent.getAction())) {
            ...
            if (null != parcelableExtra) {
                ...
                if (isConnected) {
                    playDelegate.setNetType(1);
                    LogUtils.D("playDelegate----->"+1);
...
//                        APP.getInstance().setWifi(true);
                        ...
                        playDelegate.setNetType(2);
//                        APP.getInstance().setMobile(true);
                        Log.e(TAG, "当前移动网络连接可用 ");
                    }
                } else {
                    Log.e(TAG, "当前没有网络连接，请确保你已经打开网络 ");
                    playDelegate.setNetType(0);
                }
//
//
