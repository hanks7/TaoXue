...
public class AudioPlayLiService extends Service {
...
//                  myPlayHelp.sendOnlyNotification();
     ...
     @Override
     public void setPlayBefore(boolean playBefore) throws RemoteException {
...
//        myPlayHelp=new MyPlayHelp();
    ...
    public class MyPlayHelp implements AudioPlayDelegate {
        ...
        private PhoneListener mBroadcastReceiver;//手机来电监听
...
//
//            mBroadcastReceiver = new PhoneListener(this);
...
//
//            mNetworkChangeListener = new NetworkConnectChangedReceiver(this);
//            IntentFilter filter = new IntentFilter();
//            filter.addAction("android.net.conn.CONNECTIVITY_CHANGE");
//            filter.addAction(WifiManager.WIFI_STATE_CHANGED_ACTION);
//            filter.addAction("android.net.wifi.STATE_CHANGE");
//            registerReceiver(mNetworkChangeListener, filter);//注册网络状态变化监听
        }
...
//                        setPlayPosition((int)msg.obj);
//                      if  callback((int)msg.obj);
//                         if (playPositionCallBack!=null){
//                             try{
//                                 playPositionCallBack.updateCurrentPlayPosition((int)msg.obj);
//                             }catch (Exception e){};
//                         }
                        break;
                }
...
//                isPlayRecond = true;
            ...
            AudioNotifacation.sendAudioNotification(AudioPlayLiService.this, audioUrlManager.getAudioInfo().getResource_picture(), audioUrlManager.getAudioName(), getPlayState());
        }
                          ...
                          public void onClick(View v)
                           {
                               playOrPause();
                                  // TODO Auto-generated method stub
                             Toast.makeText(AudioPlayLiService.this, "onClick", Toast.LENGTH_SHORT).show();
                              }
                   });
              }catch (Exception e){
