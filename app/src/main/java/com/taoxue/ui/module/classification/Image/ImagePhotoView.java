package com.taoxue.ui.module.classification.Image;
...
public class ImagePhotoView extends ImageView {
...
//    private RotateGestureDetector mRotateDetector;
    ...
    public ImagePhotoView(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private ScaleGestureDetector.OnScaleGestureListener mScaleListener = new ScaleGestureDetector.OnScaleGestureListener() {
        ...
        public boolean onScale(ScaleGestureDetector detector) {
            ...
            if (Float.isNaN(scaleFactor) || Float.isInfinite(scaleFactor))
                return false;
              LogUtils.D("ImagePhotoView.this.getId()"+ImagePhotoView.this.toString());
            mScale *= scaleFactor;
            LogUtils.D("mAnimaMatrix----->"+mAnimaMatrix.toString());
//            mScaleCenter.set(detector.getFocusX(), detector.getFocusY());
    ...
    private Runnable mClickRunnable = new Runnable() {
        ...
        public void run() {
            if (mClickListener != null) {
                mClickListener.onClick(ImagePhotoView.this);
            }
        }
    };
    ...
    private GestureDetector.OnGestureListener mGestureListener = new GestureDetector.SimpleOnGestureListener() {
        ...
        public void onLongPress(MotionEvent e) {
            if (mLongClick != null) {
                mLongClick.onLongClick(ImagePhotoView.this);
            }
        }
