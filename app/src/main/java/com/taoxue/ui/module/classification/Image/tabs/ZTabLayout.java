...
public class ZTabLayout extends HorizontalScrollView {
    ...
    private final ArrayList<ZTabLayout.Tab> mTabs = new ArrayList<>();
    ...
    private final ArrayList<ZTabLayout.OnTabSelectedListener> mSelectedListeners = new ArrayList<>();
    ...
    public void removeAllTabs() {
        ...
        for (final Iterator<ZTabLayout.Tab> i = mTabs.iterator(); i.hasNext();) {
