 ...
 * 资源搜索结果adapter
 */
public class QryResourceByTagAdapter extends BaseMyAdapter {

    public QryResourceByTagAdapter(Context mContext, List list) {
        super(mContext, list);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        setView(mContext,holder, (GetDetailBean) list.get(position));
        return convertView;
    }
    public void setView(Context context, LsvViewHold holder , GetDetailBean bean) {
