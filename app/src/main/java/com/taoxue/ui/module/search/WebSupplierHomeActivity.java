 ...
 *
 */
public class WebSupplierHomeActivity extends WebBaseHomeActivity {
            ...
            public void run() {
                switch (Integer.valueOf(type)) {
                    ...
                    case 2://详情 资源id 采购商id
                        ...
                        break;
                    case 3://跳转到资源供应商首页 图书馆_id
                        launch(WebLibHomeActivity.class, value);
                        break;
                }
            }
        });
    ...
    public void intentFlist(final String id,final String dr_data_id, final String name) {
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                ...
                UtilIntent.intentDIY(mActivity,WebFlistSuppActivity.class,bundle);
            }
        });
    }
