 ...
 * 供应闪全部资源
 */
public class LibAllResourcesFragment extends BaseFragment {
    @BindView(R.id.myrv)
    RecyclerView rlv;
    private int page = 1;
     ...
     */
    private void http() {
        HttpAdapter.getService().getCgsResource(pageSize,page, ids).enqueue(new OnResponseNoDialogListener<GysResourceBean>() {
            @Override
