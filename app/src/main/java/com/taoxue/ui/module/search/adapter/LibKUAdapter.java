...
public class LibKUAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public LibKUAdapter(Activity context, List<GysDrdataBean.PageBean.ResultBean> datas, boolean hasMore) {
        this.datas = datas;
