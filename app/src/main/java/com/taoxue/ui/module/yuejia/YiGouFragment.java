...
public class YiGouFragment extends BaseResourceFragment {
    ...
    public void updateData() {
        ...
        HttpAdapter.getService().getYiGous().enqueue(new OnResponseNoDialogListener<BasePageModel<BookInfoBean>>() {
            @Override
