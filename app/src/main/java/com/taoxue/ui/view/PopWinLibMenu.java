...
import com.taoxue.ui.module.search.SearchResourcesLibActivity;
 ...
 * 修改备注：
 */
public class PopWinLibMenu extends PopupWindow {
     ...
     */
    public PopWinLibMenu(Activity activity, View onclickView,String cgs_id) {
        ...
        public void onClick(View v) {
            ...
            switch (v.getId()) {
                case R.id.layout_pop_two://资源
                    ...
                    fjakdjsflsa(SearchResourcesLibActivity.class);
                    break;
