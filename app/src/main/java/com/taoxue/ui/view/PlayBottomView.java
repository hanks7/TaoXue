...
public class PlayBottomView extends LinearLayout {
    ...
    ImageView mIv4;
    Utilshare utilshare;
    public PlayBottomView(Context context, AttributeSet attrs) {
    ...
    public PlayBottomView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        ButterKnife.bind(this, view);
         ...
         utilshare = new Utilshare((Activity) getContext());
